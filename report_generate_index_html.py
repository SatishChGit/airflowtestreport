...
count_t_s,count_t_f,count_tt_s,count_tt_f=0,0,0,0
array_t=''
array_tt=''
result_t,result_tt,time_t,time_tt=[],[],0,0
...
an_item = dict(classname="tests.system.providers.teradata.example_teradata_to_teradata", successre=count_tt_s, failurere=count_tt_f,time=time_tt, status=last_tt_10_elements)
items.append(an_item)
